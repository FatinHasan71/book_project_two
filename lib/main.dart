...
void main() {
  ...
  Book book1 = Book(" Melania ", " Melania Trump ", 2024 , 0 );
  Book book2 = Book(" Blood of Elves ", " Andrzej Sapkowski ", 2022 , 0);
  Book book3 = Book(" Counting Miracles: A Novel ", " Nicholas Sparks ", 2024 , 0);
